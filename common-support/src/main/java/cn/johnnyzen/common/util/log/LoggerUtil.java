 ...
 * <p>Description: 基本思想, 按模块定义各个模块的日志实例
 *      LoggerUtil.info(LoggerUtil.WARNING_LOGGER_INSTANCE, "getWarningList:start");
 *      LoggerUtil.error(LoggerUtil.WARNING_LOGGER_INSTANCE, exception, "获取告警列表异常!");
 * </p>
 * @version 1.0
 */
public class LoggerUtil {
     ...
     * [通用]Web 控制层异常 日志定义
     */
    private static final String WEB_CONTROLLER_EXCEPTION_LOGGER = "WEB_CONTROLLER_EXCEPTION_LOGGER";

    /**
     * [通用]Web 过过滤器 日志定义
     */
    private static final String WEB_FILTER_LOGGER = "WEB_FILTER_LOGGER";

    /**
     * [通用]Web 过过滤器 日志定义
     */
    private static final String COMMON_TEST_FILTER = "COMMON_TEST_FILTER";
     ...
     *  [通用] Web控制层异常 实例
     */
    public static Logger WEB_CONTROLLER_EXCEPTION_INSTANCE = LoggerFactory.getLogger(WEB_CONTROLLER_EXCEPTION_LOGGER);

    /**
     * [通用]Web 过过滤器 日志定义
     */
    public static Logger WEB_FILTER_INSTANCE = LoggerFactory.getLogger(WEB_FILTER_LOGGER);

    public static Logger COMMON_TEST_FILTER_INSTANCE = LoggerFactory.getLogger(COMMON_TEST_FILTER);
