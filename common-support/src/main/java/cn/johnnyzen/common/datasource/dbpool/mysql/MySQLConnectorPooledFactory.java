 ...
 */
public class MySQLConnectorPooledFactory extends AbstractDatabaseConnectorPooledFactory<MySQLConnector> {
    private static final Logger logger = LoggerFactory.getLogger(MySQLConnectorPooledFactory.class);

    public MySQLConnectorPooledFactory(DataSource dataSource){
        super(dataSource);
    }
     ...
     */
    @Override
    public void activateObject(PooledObject<MySQLConnector> pooledObject) throws Exception {
        logger.debug("activate object for mysql ...");
     ...
     */
    @Override
    public void destroyObject(PooledObject<MySQLConnector> pooledObject) throws Exception {
        logger.debug("destroying object for mysql ...");
     ...
     */
    @Override
    public MySQLConnector create() throws Exception {
    ...
    @Override
    public PooledObject<MySQLConnector> wrap(MySQLConnector connector) {
        return new DefaultPooledObject<MySQLConnector>(connector);
    }
     ...
     */
    @Override
    public PooledObject<MySQLConnector> makeObject() throws Exception {
        MySQLConnector connector = new MySQLConnector(dataSource);
        connector.build();
     ...
     */
    @Override
    public void passivateObject(PooledObject<MySQLConnector> pooledObject) throws Exception {
        logger.debug("passivating object for mysql ...");
     ...
     */
    @Override
    public boolean validateObject(PooledObject<MySQLConnector> pooledObject) {
        logger.debug("validating object for mysql ...");
