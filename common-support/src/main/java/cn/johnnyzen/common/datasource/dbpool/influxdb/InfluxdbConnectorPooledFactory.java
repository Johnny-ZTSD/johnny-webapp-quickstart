 ...
 */
public class InfluxdbConnectorPooledFactory extends AbstractDatabaseConnectorPooledFactory<InfluxDbConnector> {
    private static final Logger logger = LoggerFactory.getLogger(InfluxdbConnectorPooledFactory.class);

    public InfluxdbConnectorPooledFactory(DataSource dataSource){
        super(dataSource);
    }
     ...
     */
    @Override
    public void activateObject(PooledObject<InfluxDbConnector> pooledObject) throws Exception {
        logger.debug("activate object for influxdb ...");
     ...
     */
    @Override
    public void destroyObject(PooledObject<InfluxDbConnector> pooledObject) throws Exception {
        logger.debug("destroying object for influxdb ...");
     ...
     */
    @Override
    public InfluxDbConnector create() throws Exception {
    ...
    @Override
    public PooledObject<InfluxDbConnector> wrap(InfluxDbConnector connector) {
        return new DefaultPooledObject<InfluxDbConnector>(connector);
    }
     ...
     */
    @Override
    public PooledObject<InfluxDbConnector> makeObject() throws Exception {
        InfluxDbConnector connector = new InfluxDbConnector(dataSource);
        connector.build();
     ...
     */
    @Override
    public void passivateObject(PooledObject<InfluxDbConnector> pooledObject) throws Exception {
        logger.debug("passivating object for influxdb ...");
     ...
     */
    @Override
    public boolean validateObject(PooledObject<InfluxDbConnector> pooledObject) {
        logger.debug("validating object for influxdb ...");
