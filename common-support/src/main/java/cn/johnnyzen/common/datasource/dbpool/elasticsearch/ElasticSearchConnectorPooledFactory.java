 ...
 */
public class ElasticSearchConnectorPooledFactory extends AbstractDatabaseConnectorPooledFactory<ElasticSearchConnector> {
    private static final Logger logger = LoggerFactory.getLogger(ElasticSearchConnectorPooledFactory.class);

    public ElasticSearchConnectorPooledFactory(DataSource dataSource){
        super(dataSource);
    }
     ...
     */
    @Override
    public void activateObject(PooledObject<ElasticSearchConnector> pooledObject) throws Exception {
        logger.debug("activate object for elasticsearch ...");
     ...
     */
    @Override
    public void destroyObject(PooledObject<ElasticSearchConnector> pooledObject) throws Exception {
        logger.debug("destroying object for elasticsearch ...");
     ...
     */
    @Override
    public ElasticSearchConnector create() throws Exception {
    ...
    @Override
    public PooledObject<ElasticSearchConnector> wrap(ElasticSearchConnector connector) {
        return new DefaultPooledObject<ElasticSearchConnector>(connector);
    }
     ...
     */
    @Override
    public PooledObject<ElasticSearchConnector> makeObject() throws Exception {
        ElasticSearchConnector connector = new ElasticSearchConnector(dataSource);
        connector.build();
     ...
     */
    @Override
    public void passivateObject(PooledObject<ElasticSearchConnector> pooledObject) throws Exception {
        logger.debug("passivating object for elasticsearch ...");
     ...
     */
    @Override
    public boolean validateObject(PooledObject<ElasticSearchConnector> pooledObject) {
        logger.debug("validating object for elasticsearch ...");
